...
export class CreateBenchComponent implements OnInit {
  ...
  purposeMasterList = [
    { id: 'p1', name: 'For Hearing (After Notice)', defaultPriority: 1 },
    {
      id: 'p2',
      name: 'For Priority Hearing (on Priority)',
      defaultPriority: 2,
    },
    { id: 'p3', name: 'For Judgement (For Final orders)', defaultPriority: 3 },
    { id: 'p4', name: 'For Direction', defaultPriority: 4 },
    { id: 'p5', name: 'Order/Judgement Reserved', defaultPriority: 5 },
    { id: 'p6', name: 'Date Not Fixed', defaultPriority: 6 },
    { id: 'p7', name: 'For Admission (Contempt)', defaultPriority: 7 },
    { id: 'p8', name: 'For Hearing (Part Heard)', defaultPriority: 8 },
    { id: 'p9', name: 'For Hearing (Continuation)', defaultPriority: 9 },
    { id: 'p10', name: 'For Hearing (Before Notice)', defaultPriority: 10 },
    { id: 'p11', name: 'Final Hearing', defaultPriority: 11 },
    { id: 'p12', name: 'For Admission', defaultPriority: 12 },
    { id: 'p13', name: 'For admission (with defect)', defaultPriority: 13 },
    {
      id: 'p14',
      name: 'Re-Hearing / Additional Argument',
      defaultPriority: 14,
    },
    { id: 'p15', name: 'Delivery of Judgment', defaultPriority: 15 },
    { id: 'p16', name: 'For Order', defaultPriority: 16 },
  ];
